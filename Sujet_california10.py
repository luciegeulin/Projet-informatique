...
plt.plot(temps_c1,c1_h,color='green',label='c1')
plt.plot(temps_c2,c2_h,color='orange',label='c2')
plt.plot(temps_c3,c3_h,color='purple',label='c3')
plt.plot(temps_c4,c4_h,color='blue',label='c4')
plt.plot(temps_c5,c5_h,color='red',label='c5')
plt.plot(temps_c6,c6_h,color='yellow',label='c6')
plt.legend()


###GRAPHIQUE LUM
plt.plot(temps_c1,c1_l,color='green',label='c1')
plt.plot(temps_c2,c2_l,color='orange',label='c2')
plt.plot(temps_c3,c3_l,color='purple',label='c3')
plt.plot(temps_c4,c4_l,color='blue',label='c4')
plt.plot(temps_c5,c5_l,color='red',label='c5')
plt.plot(temps_c6,c6_l,color='yellow',label='c6')
plt.legend()
